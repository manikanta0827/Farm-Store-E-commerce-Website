               ...
               <div class="row">
                  <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                     ...
                     <ul class="list-group">
                        <?php
                        $cid = $_GET['cid'];
                        $query = "SELECT subcategory.id as sid,subcategory.name,subcategory.cat_id,category.id as cid FROM category,subcategory 
                        WHERE category.id = subcategory.cat_id AND category.id = '$cid'";
                  ...
                  <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                     ...
                     <div class="row grid-6">
                        ...
                        AND product.status=1 LIMIT $page1,12 ";
                              ...
                              <div class="product iproduct clearfix">
                                 ...
                                 <div class="product-desc">
                                    <div class="product-title mb-1">
                                       ...
                                       <a href="Product?id=<?php echo $row["id"]; ?>&cid=<?php echo $row["cid"]; ?>" class="btn btn-block text-dark mt-1" style="background-color: #42bd31;"><b>
