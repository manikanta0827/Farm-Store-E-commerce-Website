               ...
               <div class="row">
                  <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                     ...
                     <ul class="list-group">
                        <?php
                        $id = $_GET['id'];
                        $query = "SELECT subcategory.id as sid,subcategory.name,subcategory.cat_id,category.id as cid 
                        FROM category,subcategory WHERE category.id = subcategory.cat_id AND category.id = '$id'";
                  ...
                  <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                     ...
                     <div class="row grid-6">
                        ...
                        $sql = "SELECT * FROM category,product WHERE category.id= product.cid 
                        AND category.id = '$id' and product.status = '1' LIMIT $page1,12";
                           ...
                           <div class="col-lg-2 col-md-3 col-6 px-2">
                              <div class="product iproduct clearfix">
                                 <div class="product-image">
                                    <a href="viewProduct.php?id=<?php echo $row["id"]; ?>&cid=<?php echo $row["cid"]; ?>">
                                    <img src="<?php echo $row['pimg']; ?>" alt="Image 1" 
                     ...
                     <span style="color:black">Out of stock</span> </del></a>
                                 ...
                                 <div class="product-desc">
                                    <div class="product-title mb-1">
                                       ...
                                       <a href="viewProduct.php?id=<?php echo $row["id"]; ?>&cid=<?php echo $row["cid"]; ?>" class="btn btn-block text-dark mt-1" style="background-color: #28a745;"><b>
                                             <i class="icon-shopping-cart"></i>&nbsp;Add to cart&nbsp;<i class="icon-shopping-cart"></i></b></a>
                                    </div>
                                 </div>
                              </div>
                           </div>
                     ...
                     for ($b = 1; $b <= $a; $b++) {
                     ?>
                        <a href="Catagory?page=<?php echo $b; ?>&id=<?php echo $id; ?>" class="btn btn-warning text-dark"><?php echo $b ?></a>
                     <?php
                     }
                     ?>
                  </div>
